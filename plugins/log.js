...
const MSG = "පණිවිඩය : \n\n"
const SUC = "*පණිවිඩය ලොග් වෙත සාර්තකව එක් කරන ලදී. ✔*"

Asiata.addcommand({ pattern: 'log', fromMe: true,  deleteCommand: false,  desc: LOG, warn: ANIM, onlyGroup: true, dontAddCommandList: true}, (async (message, match) => { 
