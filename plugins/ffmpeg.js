    ...
    Asiata.addcommand({pattern: 'ffmpeg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.FF_DESC}, (async (message, match) => {
        ...
        if (message.reply_message.video) {
            ...
            ffmpeg(location)
                ...
                .save('Asiata.mp4')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Asiata.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '▰✖🧚‍♂️ꜱʟ ᴀꜱɪᴀᴛᴀ ʙᴏᴛ🌟✖▰'});
                });
            ...
            ffmpeg(location)
                ...
                .save('Asiata.jpg')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Asiata.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: '▰✖🧚‍♂️ꜱʟ ᴀꜱɪᴀᴛᴀ ʙᴏᴛ🌟✖▰'});
                });
            return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
        }
        else {
