...
Asiata.addcommand({pattern: 'admin', desc: Lang.ADMINDESC, fromMe: true,  deleteCommand: false,  dontAddCommandList: false}, (async (message, match) => {    

    await message.sendMessage(Lang.AD_DESC);
}));

Asiata.addcommand({pattern: 'ban ?(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.BAN_DESC, dontAddCommandList: true}, (async (message, match) => {  
...
Asiata.addcommand({pattern: 'add(?: |$)(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.ADD_DESC, dontAddCommandList: true}, (async (message, match) => {  
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asiata.addcommand({pattern: 'promote ?(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.PROMOTE_DESC, dontAddCommandList: true}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asiata.addcommand({pattern: 'demote ?(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.DEMOTE_DESC, dontAddCommandList: true}, (async (message, match) => {    
    var im = await checkImAdmin(message);
...
Asiata.addcommand({pattern: 'mute ?(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.MUTE_DESC, dontAddCommandList: true}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asiata.addcommand({pattern: 'unmute ?(.*)', fromMe: true,  deleteCommand: false,  onlyGroup: true, desc: Lang.UNMUTE_DESC, dontAddCommandList: true}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asiata.addcommand({pattern: 'clear', fromMe: true,  deleteCommand: false,  desc: Lang.END, dontAddCommandList: true}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'gname ?(.*)', onlyGroup: true, fromMe: true,  deleteCommand: false,  dontAddCommandList: true}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Asiata.addcommand({pattern: 'invite ?(.*)', fromMe: true, dontAdCommandList: true, onlyGroup: true, desc: Lang.INVITE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
