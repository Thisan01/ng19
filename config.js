...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './Asiata.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'V 1.0.0 PUBLIC - STABLE 🧚‍♂️',
    ZRUN: "zenzapi",
    CHANNEL: 'https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb',
    SESSION: process.env.ASIATA_SESSION === undefined ? '' : process.env.ASIATA_SESSION,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'ASIATA' : process.env.OWNER_NAME,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/751bab3a465bbe2500948.jpg' : process.env.ALIVE_LOGO,
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? 'ASIATA OFFICIAL SUPPORT': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'ASIATA OFFICIAL TEST': process.env.GROUP_NAME_2,
    GROUPL2: process.env.GROUP_LINK_2 === undefined ? 'https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb': process.env.GROUP_LINK_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? ' 🧚‍♂️ASIATA WA BOT🧚‍♂️' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Asiata' : process.env.BOT_NAME,
    ...
    FULLSL: process.env.FULL_SL === undefined ? 'false' : process.env.FULL_SL,
    ...
    ASIATA: process.env.ASIATA === undefined ? 'ASIATA' : process.env.ASIATA,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'ASIATA' : process.env.TAG_HEADER,
    ...
    HLOCK: "hadi-api",
    ZTH: "d537895142",
    DATABASE: DATABASE_URL === './Asiata.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
