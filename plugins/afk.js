...
Amdi.addcommand({on: 'online', fromMe: true,  deleteCommand: false,  deleteCommand: false}, (async (message, match) => {
...
Amdi.addcommand({pattern: 'afk ?(.*)', fromMe: true,  deleteCommand: false,  deleteCommand: false, desc: Lang.AFK_DESC, dontAddCommandList: true}, (async (message, match) => {     
    if (!AFK.isAfk) {
