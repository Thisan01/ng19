...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'removebg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: 'Asiata-rbg.png', mimetype: Mimetype.png});
        await load.delete();
    }));
}
else if (Config.WORKTYPE == 'public') {

    Asiata.addcommand({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
