...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'unvoice', fromMe: true,  deleteCommand: false,  desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Asiata.addcommand({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
