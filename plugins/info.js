...
if (Config.WORKTYPE == 'private') {
    Asiata.addcommand({ pattern: 'info', fromMe: true,  deleteCommand: false,  desc: Lang.INFO_DESC}, async (message, match) => { 
    ...
    Asiata.addcommand({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
