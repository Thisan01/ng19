...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'tblend ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Asiata.addcommand({pattern: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC}, (async (message, match) => {    
