...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({ pattern: 'spotify ?(.*)', fromMe: true, desc: Lang.SPO_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    Asiata.addcommand({ pattern: 'spotify ?(.*)', fromMe: false, desc: Lang.SPO_DESC}, async (message, match) => {
