...
╱┗━━━━━━━━━━━┛╲`,MessageType.text);
    ...
    Asiata.addcommand({ pattern: 'insta ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {caption: "▰✖🧚‍♂️ꜱʟ ᴀꜱɪᴀᴛᴀ ʙᴏᴛ🌟✖▰"}) 
        }
          })
          .catch(
...
╱┗━━━━━━━━━━━┛╲`,MessageType.text);
    ...
    Asiata.addcommand({ pattern: 'insta ?(.*)', fromMe: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {quoted: message.data}, {caption: "▰✖🧚‍♂️ꜱʟ ᴀꜱɪᴀᴛᴀ ʙᴏᴛ🌟✖▰"}) 
        }
          })
          .catch(
