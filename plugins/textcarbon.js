...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'carbon$', fromMe: true,  deleteCommand: false,  desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
