...
Asiata.addcommand({pattern: 'tg ?(.*)', fromMe: false,  deleteCommand: false,  desc: Lang.TAGALL_DESC, dontAddCommandList: true}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,'මම මෙම සමූහයේ ඇඩ්මින් නොවේ ?\n\n I am not Admin in this group',MessageType.text);
