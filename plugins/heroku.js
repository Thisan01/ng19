...
Asiata.addcommand({pattern: 'restart', fromMe: true,  deleteCommand: false,  desc: Lang.RESTART_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'shutdown', fromMe: true,  deleteCommand: false,  desc: Lang.SHUTDOWN_DESC, dontAddCommandList: true}, (async(message, match) => {
...
Asiata.addcommand({pattern: 'dyno', fromMe: true, desc: Lang.DYNO_DESC, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'setvar ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.SETVAR_DESC, dontAddCommandList: true}, (async(message, match) => {
...
Asiata.addcommand({pattern: 'delvar ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.DELVAR_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'getvar ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.GETVAR_DESC, dontAddCommandList: true}, (async (message, match) => {
